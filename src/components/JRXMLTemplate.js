...
const JRXMLTemplate = ({onTemplateCreated}) => {
        ...
        const handleSaveTemplate = async () => {
            ...
            try {
                ...
                await axios.post(
                    `http://localhost:8080/api/reports/jrxml/templates/create?name=${templateName}`, // 'name' as a query parameter
                    variables, // 'fields' object as the request body (JSON)
                    {
                        headers: {
                            'Content-Type': 'application/json' // Important for @RequestBody
                        }
                    }
                );
